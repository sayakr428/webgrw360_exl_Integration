...
const BlogPage = () => {
  ...
  const featuredPost = {
    ...
    image: 'https://www.adroitte.in/wp-content/uploads/2025/02/2025-digital-marketing-trends-in-india-and-benefits-for-global-clients.jpg',
  ...
  const blogPosts = [
    {
      ...
      image: 'https://blogs.webmarlins.com/wp-content/uploads/2025/08/a-digital-illustration-of-a-meticulously_bg0G4-h7TqOvJuHs_bQ-Yg_jk8744lLTcuBYHanuTRxQA.png',
      author: 'Priya Sharma',
      date: '2025-01-10',
      category: 'SEO',
      readTime: '6 min read',
